    ...
    <div className="bg-gradient-to-l pt-2 rounded-md flex min-h-screen items-center flex-col h-screen space-y-12 2xl:md:px-5 xl:md:px-5 lg:md:px-5 md:px-5 px-2">
        <div className="w-full max-w-screen-2xl mx-auto px-3 sm:px-10 flex rounded-md h-[70%]">
          ...
          <div className='container1 relative flex h-1/2 w-full'>
              <img src='/med5.jpg' alt='rwanda' className='himage w-full object-cover transform hover:scale-100 transition-transform duration-500' />
              <div className='middle bg-slate-700 rounded-lg p-4 absolute top-1/3 left-1/3 space-y-3 flex-col text-white'>
            ...
            <div className='container1 relative flex h-1/2'>
              <img src='/med3.jpg' alt='rwanda' className='himage w-full object-cover transform hover:scale-100 transition-transform duration-500' />
              <div className='middle bg-slate-700 rounded-lg p-4 absolute top-1/3 left-1/3 space-y-3 flex-col text-white'>
